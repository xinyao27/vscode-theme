...
const template = {
  ...
  colors: {
    ...
    'selection.background': palette.selection[0],
    ...
    // Button control
    'button.background': palette.primary[1],
    'button.hoverBackground': palette.primary[0],
    // Dropdown control
    ...
    'scrollbarSlider.background': palette.selection[0],
    'scrollbarSlider.hoverBackground': palette.selection[1],
    'scrollbarSlider.activeBackground': palette.selection[2],
    // Badge
    ...
    // List and trees
    'list.activeSelectionBackground': palette.selection[0],
    ...
    'list.hoverBackground': palette.selection[0],
    ...
    'minimapSlider.background': palette.selection[0],
    'minimapSlider.hoverBackground': palette.selection[1],
    'minimapSlider.activeBackground': palette.selection[2],
    // Editor Groups & Tabs
    ...
    'editor.selectionBackground': palette.selection[1],
    'editor.selectionHighlightBorder': palette.selection[2],
    'editor.wordHighlightBackground': palette.border[0],
    'editor.wordHighlightStrongBackground': palette.border[0],
    'editor.findMatchBackground': palette.secondary[2],
    'editor.findMatchHighlightBackground': palette.secondary[2],
    'editor.findMatchHighlightBorder': palette.secondary[2],
    'editor.findMatchBorder': palette.secondary[2],
    'searchEditor.findMatchBorder': palette.secondary[0],
    ...
    'editorGutter.modifiedBackground': palette.secondary[1],
    'editorGutter.addedBackground': palette.secondary[1],
    'editorGutter.deletedBackground': palette.destructive[1],
    // Diff editor colors
    'diffEditor.insertedTextBackground': palette.secondary[2],
    'diffEditor.removedTextBackground': palette.destructive[2],
    'diffEditor.border': palette.border[0],
    'diffEditor.diagonalFill': palette.border[0],
    'diffEditor.insertedLineBackground': palette.secondary[2],
    'diffEditor.removedLineBackground': palette.destructive[2],
    ...
    'peekViewResult.selectionBackground': palette.selection[1],
    ...
    'terminal.selectionBackground': palette.selection[0],
    'terminal.tab.activeBorder': palette.primary[0],
    // Git colors
    'gitDecoration.addedResourceForeground': palette.secondary[0],
