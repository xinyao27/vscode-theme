...
export const Themes = {
  ...
  string: ['#888888', '#444444'],
  punctuation: ['#666666', '#999999'],
  builtin: ['#ffffff9f', '#0000005f'],
  operator: ['#ffffff9f', '#0000005f'],
  keyword: ['#ffffff9f', '#0000005f'],
  function: ['#c391e6', '#c391e690'],
  number: ['#f6c177', '#f6c17790'],
  boolean: ['#f6c177', '#f6c17790'],
  regex: ['#f6c177', '#f6c17790'],
  variable: ['#ed9cc2', '#ed9cc290'],
  constant: ['#ed9cc2', '#ed9cc290'],
  class: ['#ed9cc2', '#ed9cc290'],
  type: ['#ed9cc2', '#ed9cc290'],
  interface: ['#ed9cc2', '#ed9cc290'],
  property: ['#ed9cc2', '#ed9cc290'],
  namespace: ['#ed9cc2', '#ed9cc290'],
  decorator: ['#ed9cc2', '#ed9cc290'],
