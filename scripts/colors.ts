...
export const Themes = {
  ...
  ignored: ['#dedcd550', colors.neutral['200']],
  faded: ['#dedcd510', colors.neutral['200']],
  border: [colors.dark['400'], colors.neutral['200']],

  background: [colors.neutral['950'], colors.neutral['100']],
  ...
  softActiveBackground: [colors.dark['400'], '#E7E5DB'],
  softBorder: [colors.dark['400'], '#E7E5DB'],
  ...
  comment: ['#ffffff4f', colors.neutral['500']],
  string: [colors.neutral['400'], colors.neutral['600']],
  punctuation: ['#666666', '#dbd7cacc'],
  builtin: ['#ffffff9f', colors.neutral['500']],
  operator: ['#ffffff9f', colors.pink['300']],
  keyword: ['#ffffff9f', colors.pink['300']],
  ...
  variable: [colors.pink['300'], colors.pink['500']],
  constant: [colors.pink['300'], colors.pink['300']],
  class: [colors.pink['300'], colors.pink['300']],
  type: [colors.pink['300'], colors.pink['300']],
  interface: [colors.pink['300'], colors.pink['300']],
  property: [colors.pink['300'], colors.pink['500']],
  namespace: [colors.pink['300'], colors.pink['300']],
  decorator: [colors.pink['300'], colors.pink['300']],

  // colors
  green: [colors.green['600'], colors.green['500']],
  cyan: [colors.cyan['500'], colors.cyan['500']],
  blue: [colors.sky['700'], colors.sky['500']],
